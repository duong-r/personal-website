...
const getInTouch = {
  ...
  message:
      "I'm always looking for opportunities to connect with others and grow professionally. If the feelings mutual, even if its just to say hi, please feel free to email me at:",
